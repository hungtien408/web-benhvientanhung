...
namespace TLLib
{
    public class ProjectCategory
    {
        ...
        public string ProjectCategoryInsert(
            ...
            string ProjectCategoryLink,
            string ProjectCategoryLinkEn,
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ProjectCategoryLink", string.IsNullOrEmpty(ProjectCategoryLink) ? dbNULL : (object)ProjectCategoryLink);
                cmd.Parameters.AddWithValue("@ProjectCategoryLinkEn", string.IsNullOrEmpty(ProjectCategoryLinkEn) ? dbNULL : (object)ProjectCategoryLinkEn);
        ...
        public string ProjectCategoryInsert2(
            string ProjectCategoryName,
            string ProjectCategoryNameEn,
            string ProjectCategoryLink,
            string ProjectCategoryLinkEn,
        ...
        )
        {
            ...
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_ProjectCategory_Insert2", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ProjectCategoryName", string.IsNullOrEmpty(ProjectCategoryName) ? dbNULL : (object)ProjectCategoryName);
                cmd.Parameters.AddWithValue("@ProjectCategoryNameEn", string.IsNullOrEmpty(ProjectCategoryNameEn) ? dbNULL : (object)ProjectCategoryNameEn);
                cmd.Parameters.AddWithValue("@ProjectCategoryLink", string.IsNullOrEmpty(ProjectCategoryLink) ? dbNULL : (object)ProjectCategoryLink);
                ...
                SqlParameter imageNameParam = new SqlParameter("@OutImageName", null);
                SqlParameter imageName2Param = new SqlParameter("@OutImageName2", null);
                SqlParameter imageNameIconParam = new SqlParameter("@OutImageNameIcon", null);
                SqlParameter errorCodeParam = new SqlParameter("@ErrorCode", null);
                imageNameParam.Size = 100;
                imageName2Param.Size = 100;
                imageNameIconParam.Size = 100;
                errorCodeParam.Size = 4;
                errorCodeParam.Direction = imageNameParam.Direction = imageName2Param.Direction = imageNameIconParam.Direction = ParameterDirection.Output;
                cmd.Parameters.Add(imageNameParam);
                cmd.Parameters.Add(imageName2Param);
                cmd.Parameters.Add(imageNameIconParam);
                cmd.Parameters.Add(errorCodeParam);
                scon.Open();
                cmd.ExecuteNonQuery();
                scon.Close();
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_ProjectCategory_Insert2' reported the ErrorCode : " + errorCodeParam.Value.ToString());
        ...
        public int ProjectCategoryUpdate2(
            string ProjectCategoryID,
            string ProjectCategoryName,
            string ProjectCategoryNameEn,
            string ProjectCategoryLink,
        ...
        )
        {
            ...
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_ProjectCategory_Update2", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ProjectCategoryID", string.IsNullOrEmpty(ProjectCategoryID) ? dbNULL : (object)ProjectCategoryID);
                cmd.Parameters.AddWithValue("@ProjectCategoryName", string.IsNullOrEmpty(ProjectCategoryName) ? dbNULL : (object)ProjectCategoryName);
                cmd.Parameters.AddWithValue("@ProjectCategoryNameEn", string.IsNullOrEmpty(ProjectCategoryNameEn) ? dbNULL : (object)ProjectCategoryNameEn);
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_ProjectCategory_Update2' reported the ErrorCode : " + errorCodeParam.Value.ToString());
        ...
        public int ProjectCategoryImage2Delete(
            string ProjectCategoryID
        )
        {
            try
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_ProjectCategoryImage2_Delete", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ProjectCategoryID", string.IsNullOrEmpty(ProjectCategoryID) ? dbNULL : (object)ProjectCategoryID);
                SqlParameter errorCodeParam = new SqlParameter("@ErrorCode", null);
                errorCodeParam.Size = 4;
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_ProjectCategoryImage2_Delete' reported the ErrorCode : " + errorCodeParam.Value.ToString());
        ...
        public int ProjectCategoryImageIconDelete(
            string ProjectCategoryID
        )
        {
            try
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_ProjectCategoryImageIcon_Delete", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ProjectCategoryID", string.IsNullOrEmpty(ProjectCategoryID) ? dbNULL : (object)ProjectCategoryID);
                SqlParameter errorCodeParam = new SqlParameter("@ErrorCode", null);
                errorCodeParam.Size = 4;
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_ProjectCategoryImageIcon_Delete' reported the ErrorCode : " + errorCodeParam.Value.ToString());

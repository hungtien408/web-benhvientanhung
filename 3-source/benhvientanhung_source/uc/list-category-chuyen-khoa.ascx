<%@ Control Language="C#" AutoEventWireup="true" CodeFile="list-category-chuyen-khoa.ascx.cs" Inherits="uc_list_category_about" %>
<section class="aside-list">
    ...
    <div class="list-ul">
        ...
        <asp:ObjectDataSource ID="odsGioiThieu" runat="server" SelectMethod="ProjectCategorySelectAll" TypeName="TLLib.ProjectCategory">
            <SelectParameters>
                <asp:Parameter DefaultValue="57" Name="parentID" Type="Int32" />

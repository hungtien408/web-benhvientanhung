        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Link danh mục" DataField="ProjectCategoryLink" SortExpression="ProjectCategoryLink">
                        <ItemTemplate>
                            <asp:Label ID="lblProjectCategoryLink" runat="server" Text='<%# Eval("ProjectCategoryLink")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Link danh mục(En)" DataField="ProjectCategoryLinkEn" SortExpression="ProjectCategoryLinkEn">
                        <ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="bacsi.aspx.cs" Inherits="ad_single_project" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProjectTitleEn" HeaderText="Tiêu đề(En)" SortExpression="ProjectTitle" />
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Đội Ngũ Bác Sỹ</h3>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 201px x 277px)</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="left" valign="top">Ngoại ngữ
                                    </td>
                                    <td>
                                        ...
                                        <asp:RadTextBox ID="txtDescription" runat="server" Text='<%# Bind("Description") %>'
                                            Width="500px" EmptyMessage="Ngoại ngữ">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Chức Vụ ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtTag" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Chuyên ngành ...">
                <TargetControls>
            ...
            <asp:TextBoxSetting EmptyMessage="Chức Vụ(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtTagEn" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Chuyên ngành(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtMetaTittleEn" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Kinh nghiệm(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtMetaDescriptionEn" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Họ tên(En) ...">
                <TargetControls>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="17" Name="ProjectCategoryID" PropertyName="SelectedValue"
                Type="String" />

...
public partial class ad_single_video : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            string VideoID, Priority, IsAvailable, IsHot, IsNew;
            var oVideo = new Video();
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            var strPhotoCategoryID = ((RadComboBox)row.FindControl("ddlPhotoCategory")).SelectedValue;
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                dsInsertParam["PhotoCategoryID"].DefaultValue = strPhotoCategoryID;
                dsInsertParam["IsAvailable"].DefaultValue = strIsAvailable;
                dsInsertParam["IsHot"].DefaultValue = IsHot;
                dsInsertParam["IsNew"].DefaultValue = IsNew;
            ...
            else
            {
                ...
                dsUpdateParam["PhotoCategoryID"].DefaultValue = strPhotoCategoryID;
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem && e.Item.IsInEditMode)
        {
            ...
            var ddlPhotoCategory = (RadComboBox)row.FindControl("ddlPhotoCategory");
            ...
            if (!string.IsNullOrEmpty(VideoID))
            {
                ...
                if (!string.IsNullOrEmpty(dv[0]["PhotoCategoryID"].ToString()))
                    ddlPhotoCategory.SelectedValue = dv[0]["PhotoCategoryID"].ToString();
            }

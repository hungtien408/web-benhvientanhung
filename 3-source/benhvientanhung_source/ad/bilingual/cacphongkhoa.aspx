<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="cacphongkhoa.aspx.cs" Inherits="ad_single_projectcategory" %>
    ...
    <script type="text/javascript">
        ...
        function conditionalPostback(sender, eventArgs) {
            ...
            if (eventArgs.get_eventTarget().match(theRegexp)) {
                ...
                var upload3 = $find(window['UploadId3']);

                //AJAX is disabled only if file is selected for upload
                if (upload.getFileInputs()[0].value != "" || upload2.getFileInputs()[0].value != "" || upload3.getFileInputs()[0].value != "") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Link danh mục" DataField="ProjectCategoryLink" SortExpression="ProjectCategoryLink" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblProjectCategoryLink" runat="server" Text='<%# Eval("ProjectCategoryLink")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Link danh mục(En)" DataField="ProjectCategoryLinkEn" SortExpression="ProjectCategoryLinkEn" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblProjectCategoryLinkEn" runat="server" Text='<%# Eval("ProjectCategoryLinkEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                <%--<a class="screenshot" rel='../../res/projectcategory/<%# Eval("ImageName") %>'>
                                    <img alt="" src="../assets/images/photo.png" />
                                </a>--%>
                                <img id="Img1" alt="" src='<%# "~/res/projectcategory/" + Eval("ImageName") %>' width="80"
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh 2">
                        <ItemTemplate>
                            <asp:Panel ID="PanelAnh2" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName2").ToString()) ? false : true %>'>
                                <%--<a class="screenshot" rel='../../res/projectcategory/<%# Eval("ImageName") %>'>
                                    <img alt="" src="../assets/images/photo.png" />
                                </a>--%>
                                <img id="Img2" alt="" src='<%# "~/res/projectcategory/image2/" + Eval("ImageName2") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ImageName2").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage2" runat="server" CommandName="DeleteImage2" OnClientClick="return confirm('Xóa ảnh này ?')"
                                    rel='<%#  Eval("ProjectCategoryID") + "#" + Eval("ImageName2") %>'>
                            <img alt="Xóa ảnh" title="Xóa ảnh" src="../assets/images/delete-icon.png" />
                                </asp:LinkButton>
                                <asp:HiddenField ID="hdnImageName2" runat="server" Value='<%# Eval("ImageName2") %>' />
                            </asp:Panel>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Ảnh Icon">
                        <ItemTemplate>
                            <asp:Panel ID="PanelAnhIcon" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageNameIcon").ToString()) ? false : true %>'>
                                <%--<a class="screenshot" rel='../../res/projectcategory/<%# Eval("ImageName") %>'>
                                    <img alt="" src="../assets/images/photo.png" />
                                </a>--%>
                                <img id="Img3" alt="" src='<%# "~/res/projectcategory/icon/" + Eval("ImageNameIcon") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ImageNameIcon").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImageIcon" runat="server" CommandName="DeleteImageIcon" OnClientClick="return confirm('Xóa ảnh này ?')"
                                    rel='<%#  Eval("ProjectCategoryID") + "#" + Eval("ImageNameIcon") %>'>
                            <img alt="Xóa ảnh" title="Xóa ảnh" src="../assets/images/delete-icon.png" />
                                </asp:LinkButton>
                                <asp:HiddenField ID="hdnImageNameIcon" runat="server" Value='<%# Eval("ImageNameIcon") %>' />
                            </asp:Panel>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                </Columns>
                <EditFormSettings EditFormType="Template">
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Danh Mục Các Chuyên Khoa</h3>
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 160px x 111px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">Ảnh đại diện 2
                                    </td>
                                    <td>
                                        <asp:HiddenField ID="hdnImageName2" runat="server" Value='<%# Eval("ImageName2") %>' />
                                        <asp:RadUpload ID="FileImageName2" runat="server" AllowedFileExtensions=".jpg,.jpeg,.gif,.png"
                                            ControlObjectsVisibility="None" Culture="vi-VN" InputSize="69" Language="vi-VN" />
                                        <asp:CustomValidator ID="CustomValidator2" runat="server" ClientValidationFunction="validateRadUpload"
                                            Display="Dynamic" ErrorMessage="Sai định dạng ảnh (*.jpg, *.jpeg, *.gif, *.png)"></asp:CustomValidator>
                                        <span class="required">(Kích thước 300px x 215px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">Icon
                                    </td>
                                    <td>
                                        <asp:HiddenField ID="hdnImageNameIcon" runat="server" Value='<%# Eval("ImageNameIcon") %>' />
                                        <asp:RadUpload ID="FileImageNameIcon" runat="server" AllowedFileExtensions=".jpg,.jpeg,.gif,.png"
                                            ControlObjectsVisibility="None" Culture="vi-VN" InputSize="69" Language="vi-VN" />
                                        <asp:CustomValidator ID="CustomValidator3" runat="server" ClientValidationFunction="validateRadUpload"
                                            Display="Dynamic" ErrorMessage="Sai định dạng ảnh (*.jpg, *.jpeg, *.gif, *.png)"></asp:CustomValidator>
                                        <span class="required">(Kích thước 58px x 53px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                ...
                                <tr class="invisible">
                                    <td class="left" valign="top">Link danh mục
                                    </td>
                                    <td>
                                        <asp:RadTextBox ID="txtProjectCategoryLink" runat="server" Text='<%# Bind("ProjectCategoryLink") %>'
                                            Width="500px" EmptyMessage="Link danh mục...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                ...
                                <tr class="invisible">
                                    <td class="left" valign="top">Link danh mục(En)
                                    </td>
                                    <td>
                                        <asp:RadTextBox ID="txtProjectCategoryLinkEn" runat="server" Text='<%# Bind("ProjectCategoryLinkEn") %>'
                                            Width="500px" EmptyMessage="Link danh mục(En)...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProjectCategoryDelete"
        SelectMethod="ProjectCategorySelectAll" TypeName="TLLib.ProjectCategory" UpdateMethod="ProjectCategoryUpdate2"
        InsertMethod="ProjectCategoryInsert2">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="ProjectCategoryLink" Type="String" />
            <asp:Parameter Name="ProjectCategoryLinkEn" Type="String" />

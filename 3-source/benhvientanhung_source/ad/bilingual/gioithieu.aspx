<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="gioithieu.aspx.cs" Inherits="ad_single_project" %>
                            ...
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 377px x 375px)</span>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="10" Name="ProjectCategoryID" PropertyName="SelectedValue"
                Type="String" />

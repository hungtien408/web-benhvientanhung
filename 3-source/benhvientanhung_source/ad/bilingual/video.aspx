...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Tiêu đề video" DataField="Title" SortExpression="Title" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn HeaderText="Danh Mục" DataField="PhotoCategoryName"
                        SortExpression="PhotoCategoryName" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="IsNew" HeaderStyle-Width="1%" HeaderText="Xem trên trang chủ"
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 195px x 135px)</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlPhotoCategory" runat="server" DataSourceID="ObjectDataSource3"
                                            DataTextField="PhotoCategoryName" DataValueField="PhotoCategoryID" Width="504px"
                                            OnDataBound="DropDownList_DataBound">
                                        </asp:RadComboBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="left" colspan="2">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:CheckBox ID="chkIsNew" runat="server" CssClass="checkbox" Text=" Xem trên trang chủ" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew"))%>' />
                                        &nbsp;&nbsp;
    ...
    <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="PhotoCategorySelectAll"

...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                                            ...
                                            <div class="cont">
                                                <table class="search">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlPhotoCategory" runat="server" DataSourceID="ObjectDataSource2"
                                                    ...
                                                    <tr>
                                                        <td class="left" valign="top">Tên Album
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="left" valign="top">Tên Album(En)
                                                        </td>
                                                        <td>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" style="padding-right: 10px">
                                                                                <table class="search" width="100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="left" style="width: 70px">Tiêu đề ảnh(En)
                                                                                        </td>
                                                                                        <td>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="PhotoCategorySelectAll"

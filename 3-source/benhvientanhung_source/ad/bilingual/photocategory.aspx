<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="photocategory.aspx.cs" Inherits="ad_single_photoalbum" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchPhotoCategoryName" runat="server" Width="300px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="PhotoCategoryID" SortExpression="PhotoCategoryID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Danh Mục" DataField="PhotoCategoryName"
                        SortExpression="PhotoCategoryName">
                        <ItemTemplate>
                            <asp:Label ID="lblPhotoCategoryName" runat="server" Text='<%# Eval("PhotoCategoryName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Danh Mục(Tiếng Anh)" DataField="PhotoCategoryNameEn"
                        SortExpression="PhotoCategoryNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblPhotoCategoryNameEn" runat="server" Text='<%# Eval("PhotoCategoryNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                <%--<a class="screenshot" rel='../../res/PhotoCategory/<%# Eval("ImageName") %>'>
                                    <img alt="" src="../assets/images/photo.png" />
                                </a>--%>
                                <img alt="" src='<%# "~/res/PhotoCategory/" + Eval("ImageName") %>' width="80" runat="server"
                                    visible='<%# string.IsNullOrEmpty(Eval("ImageName").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("PhotoCategoryID") + "#" + Eval("ImageName") %>'
                            ...
                            <table width="100%">
                                <tr>
                                    <td valign="top" style="width: 500px">
                                        <div class="sub_box">
                                            <div class="head">
                                                Thông Tin Danh Mục Thư Viện Ảnh
                                            </div>
                                            <div class="cont">
                                                <table class="search">
                                                    <tr class="invisible">
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="required">(Kích thước 206px x 196px)</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="left" valign="top">
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtPhotoCategoryName" runat="server" Text='<%# Bind("PhotoCategoryName") %>'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtPhotoCategoryNameEn" runat="server" Text='<%# Bind("PhotoCategoryNameEn") %>'
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="PhotoCategoryDelete"
        InsertMethod="PhotoCategoryInsert" SelectMethod="PhotoCategorySelectAll"
        TypeName="TLLib.PhotoCategory" UpdateMethod="PhotoCategoryUpdate">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="PhotoCategoryNameEn" Type="String" />
            <asp:Parameter Name="ConvertedPhotoCategoryName" Type="String" />
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchPhotoCategoryName" Name="PhotoCategoryName"

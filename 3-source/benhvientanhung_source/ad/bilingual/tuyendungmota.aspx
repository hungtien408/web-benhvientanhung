<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="tuyendungmota.aspx.cs" Inherits="ad_single_projectcategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProjectCategoryName" runat="server" Text='<%# Bind("ProjectCategoryName") %>'
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProjectCategoryLink" runat="server" Text='<%# Bind("ProjectCategoryLink") %>'
                                            Width="500px" EmptyMessage="Link danh mục..."></asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left" valign="top">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProjectCategoryNameEn" runat="server" Text='<%# Bind("ProjectCategoryName") %>'
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProjectCategoryLinkEn" runat="server" Text='<%# Bind("ProjectCategoryLinkEn") %>'
                                            Width="500px" EmptyMessage="Link danh mục(En)..."></asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left" valign="top">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProjectCategoryDelete"
        SelectMethod="ProjectCategorySelectOne" TypeName="TLLib.ProjectCategory" UpdateMethod="ProjectCategoryUpdate"

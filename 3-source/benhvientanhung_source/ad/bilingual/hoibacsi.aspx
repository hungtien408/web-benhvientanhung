<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminRole.master" AutoEventWireup="true"
    CodeFile="hoibacsi.aspx.cs" Inherits="ad_single_project" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Hỏi Bác Sĩ</h3>
                            ...
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 89px x 89px)</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="left" valign="top">Câu hỏi
                                    </td>
                                    <td>
                                        ...
                                        <asp:RadTextBox ID="txtDescription" runat="server" Text='<%# Bind("Description") %>'
                                            Width="500px" EmptyMessage="Câu hỏi" TextMode="MultiLine" Height="200">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">Trả lời
                                    </td>
                                    <td>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Người gửi ...">
                <TargetControls>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="53" Name="ProjectCategoryID" PropertyName="SelectedValue"
                Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ProjectCategorySelectAll"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="53" Name="parentID" Type="Int32" />

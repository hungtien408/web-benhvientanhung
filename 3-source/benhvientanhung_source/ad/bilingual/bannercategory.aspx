<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="bannercategory.aspx.cs" Inherits="ad_single_advertisement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Tiêu đề" DataField="CompanyName" SortExpression="CompanyName">
                        <ItemTemplate>
                            <%# Eval("CompanyName")%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn HeaderText="Link" DataField="Website" SortExpression="Website">
                        <ItemTemplate>
                        ...
                        <ItemTemplate>
                            <div style="position: relative">
                                ...
                                <div runat="server" visible='<%# string.IsNullOrEmpty(Eval("FileName").ToString()) ? false : (!Eval("FileName").ToString().ToLower().EndsWith(".swf") ? true : false) %>'>
                                    <img id="Img2" alt="" height="80" width="100" src='<%# "../../res/advertisement/" + Eval("FileName") %>' />
                                </div>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 65px x 65px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Link ...">
                <TargetControls>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="AdsBannerDelete"
        SelectMethod="AdsBannerSelectAll" TypeName="TLLib.AdsBanner" UpdateMethod="AdsBannerUpdate1">
        <DeleteParameters>

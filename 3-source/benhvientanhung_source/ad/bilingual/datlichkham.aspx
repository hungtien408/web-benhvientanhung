<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="datlichkham.aspx.cs" Inherits="ad_single_partner" %>
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                ...
                <tr>
                    <td class="left">Tổng số đặt hẹn
                    </td>
                    <td>
                        <asp:Label ID="lblTongSoDatHen" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="DatLichKhamID" SortExpression="DatLichKhamID" Visible="false">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ngày Sinh" DataField="NgaySinh" SortExpression="NgaySinh">
                        <ItemTemplate>
                            <%# string.Format("{0:dd/MM/yyyy}", Eval("NgaySinh")) %>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Giới Tính" DataField="GioiTinh" SortExpression="GioiTinh">
                        <ItemTemplate>
                            <%# Eval("GioiTinh").ToString() == "1" ? "Nam" : "Nữ" %>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Điện Thoại" DataField="DienThoai" SortExpression="DienThoai">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn HeaderText="Chuyên Khoa" DataField="ProjectCategoryName" SortExpression="ProjectCategoryName">
                        <ItemTemplate>
                            <asp:Label ID="lblChuyenKhoa" runat="server" Text='<%# Eval("ProjectCategoryName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Bác Sĩ" DataField="ProjectTitle" SortExpression="ProjectTitle">
                        <ItemTemplate>
                            <asp:Label ID="lblBacSi" runat="server" Text='<%# Eval("ProjectTitle")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Ngày Khám" DataField="NgayKham" SortExpression="NgayKham">
                        <ItemTemplate>
                            <%# string.Format("{0:dd/MM/yyyy hh:mm tt}", Eval("NgayKham")) %>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Đặt Lịch Khám</h3>
                            <table class="search">
                                <tr>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Mùi Hương ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtDatLichKhamName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Mùi Hương(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtDatLichKhamNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>

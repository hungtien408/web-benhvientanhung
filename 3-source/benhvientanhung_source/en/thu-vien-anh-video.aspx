<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-sub.master" AutoEventWireup="true" CodeFile="thu-vien-anh-video.aspx.cs" Inherits="thu_vien_anh" %>
            ...
            <asp:ListView ID="lstPhotoCategory1" runat="server" DataSourceID="odsPhotoCategory"
                ...
                <ItemTemplate>
                    <li role="presentation">
                        <a href='<%# "#tab" + Eval("PhotoCategoryID") %>' aria-controls="tab" role="tab" data-toggle="tab"><%# Eval("PhotoCategoryNameEn") %></a>
                    </li>
                </ItemTemplate>
                <LayoutTemplate>

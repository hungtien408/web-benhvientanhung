<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-sub.master" AutoEventWireup="true" CodeFile="bang-gia-dich-vu.aspx.cs" Inherits="bang_gia_dv" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="page_main" Runat="Server">
    ...
    <asp:ObjectDataSource ID="odsBangGiaDV" runat="server" SelectMethod="ProjectSelectAll" TypeName="TLLib.Project">
        <SelectParameters>
            ...
            <asp:QueryStringParameter QueryStringField="bg" Name="ProjectCategoryID" Type="String" />

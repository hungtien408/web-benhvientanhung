<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-sub.master" AutoEventWireup="true" CodeFile="tuyen-dung.aspx.cs" Inherits="tuyen_dung" %>
...
<%@ Register Src="~/en/uc/banner-career.ascx" TagPrefix="uc4" TagName="bannercareer" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="page_main" runat="Server">
    <h1 class="content-tit">Career</h1>
    <h2 style="display:none;"><a href='<%= HttpContext.Current.Request.Url.Host + "" + HttpContext.Current.Request.Url.AbsolutePath %>' title='Career'>Career</a></h2>
                ...
                <div class="accodion-content">
                    <asp:ListView ID="lstTuyenDung" runat="server" DataSourceID="odsTuyenDung"
                        ...
                        <ItemTemplate>
                            <div class="faq">
                                <div class="tin-title">
                                    <div class="td-location"><%# Eval("ProjectTitleEn") %></div>
